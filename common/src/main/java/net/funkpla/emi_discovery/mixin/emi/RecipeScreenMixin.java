...
public class RecipeScreenMixin {
  ...
  private Set<Map.Entry<EmiRecipeCategory, List<EmiRecipe>>> shemp(
      Map<EmiRecipeCategory, List<EmiRecipe>> instance,
      Operation<Set<Map.Entry<EmiRecipeCategory, List<EmiRecipe>>>> original) {

      return instance.entrySet().stream().filter((category,recipes)->
